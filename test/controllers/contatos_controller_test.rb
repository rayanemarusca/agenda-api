...
class ContatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post contatos_url, params: { contato: { data_de_nascimento: @contato.data_de_nascimento, email: @contato.email, nome: @contato.nome } }, as: :json
    end
  ...
  test "should update contato" do
    patch contato_url(@contato), params: { contato: { data_de_nascimento: @contato.data_de_nascimento, email: @contato.email, nome: @contato.nome } }, as: :json
    assert_response 200
  end
